<?php
get_header();
$villas_postID = 54; //villas page with info
$term = get_queried_object();
?>
<main>
	<div class="page-top all-vilass" style="background-image: url(<?php the_field('block1_bg_image', $villas_postID); ?>);">
		<div class="container">
			<h1 class="h1"><?php the_field('block1_title', $villas_postID); ?></h1> 
		</div> 
		...
		<div class="container">
			...
			<div class="text-and-2-img__body">
				<div class="text-and-2-img__text">
					<div class="subtitle"><?php the_field('block2_subtitle', $villas_postID); ?></div>
					<h3 class="h3"><?php the_field('block2_title', $villas_postID); ?></h3>
					<div class="desc">
						<?php the_field('block2_text1', $villas_postID); ?>
					</div>
					<?php $btn = get_field('block2_btn', $villas_postID); ?>
					<a href="<?php echo $btn["btn_link"]; ?>" class="btn-2 link-to">
						<?php echo $btn["btn_text"]; ?>
					</a>
				</div>
				<?php $block_images = get_field('block2_images', $villas_postID); ?>
				<?php if($block_images) : ?>
			...
			<div class="bottom-desc">
				<div class="bottom-desc__text">
					<?php the_field('block2_bottom_text_1', $villas_postID); ?> 
				</div>
				<h4 class="h4"><?php the_field('block2_bottom_text_2', $villas_postID); ?></h4>
			</div>
	...
	<section class="the-duo the-attention color scroll" data-color="#F3FAFC">
		<div class="container">
			<div class="the-duo__title">
				<div class="title">
					<h3 class="h3"><?php the_field('block3_title', $villas_postID); ?> </h3>
					<div class="subtitle"><?php the_field('block3_subtitle', $villas_postID); ?></div>
				</div>
				<div class="desc"><?php the_field('block3_text', $villas_postID); ?></div>
			</div>
		</div>
		<div class="scroll__body">
			<?php echo wp_get_attachment_image(get_field('block3_image', $villas_postID), 'full'); ?>
		</div>
		<div class="container bottom">
			<div class="description"><?php the_field('block3_text_on_image', $villas_postID); ?></div>
		</div>
	</section>
		...
		<div class="container">
			<div class="dnevertheless__body">
				<div class="dnevertheless__left">
					<div class="subtitle"><?php the_field('block4_subtitle', $villas_postID); ?></div>
					<h3 class="h3"><?php the_field('block4_title1', $villas_postID); ?></h3>
					<div class="desc"><?php the_field('block4_text1', $villas_postID); ?></div>
					<?php echo wp_get_attachment_image(get_field('block4_image1', $villas_postID), 'full', null, array('class' => 'img1')); ?>
				</div>
				<div class="dnevertheless__right">
					<div class="dnevertheless__img">
						<?php echo wp_get_attachment_image(get_field('block4_image2', $villas_postID), 'full', null, array('class' => 'img2')); ?>
						
						<?php if(have_rows('block4_environment_list', $villas_postID)) : ?>
							<div class="dnevertheless__items">
								<h4 class="h4"><?php the_field('block4_list_title', $villas_postID); ?></h4> 
								<?php while(have_rows('block4_environment_list', $villas_postID)) : the_row(); ?>
					...
					<h3 class="h3"><?php the_field('block4_title2', $villas_postID); ?></h3>
					<div class="desc"><?php the_field('block4_text2', $villas_postID); ?></div>
					
					<?php 
					$svg = file_get_contents(get_field('block4_bg_logo', $villas_postID));
					echo $svg;
					?>
					
					<div class="mob-img">
						<?php echo wp_get_attachment_image(get_field('block4_image1', $villas_postID), 'full', null, array('class' => 'img3')); ?>
					</div>        
				</div>
			</div>
	...
	<section class="paralax-scroll" style="background-image: url(<?php the_field('block5_bg_image', $villas_postID); ?>);">
		<div class="container">
			<div class="paralax-scroll__body">
				<?php if($top_content_block = get_field('block5_top_left_text_block', $villas_postID)) : ?>
				...
				<?php if($bottom_content_block = get_field('block5_bottom_right_text_block', $villas_postID)) : ?>
		...
		<div class="container">
			...
			<div class="relax-unwind__body">
				<div class="relax-unwind__images">
					<?php echo wp_get_attachment_image(get_field('block6_main_image', $villas_postID), 'full', null, array('class' => 'img1')); ?>
					
					<?php if($secondary_images = get_field('block6_secondary_images', $villas_postID)) : ?>
						<div class="images">
							<img src="<?php echo wp_get_attachment_image_url($secondary_images["image_1"], 'medium_large'); ?>" class="img2">
							<img src="<?php echo wp_get_attachment_image_url($secondary_images["image_2"], 'medium_large'); ?>" class="img3">
				...
				<div class="relax-unwind__right">
					<h3 class="h3"><?php the_field('block6_title', $villas_postID); ?></h3>
					<div class="desc"><?php the_field('block6_text1', $villas_postID); ?></div>

				</div>
			</div>
			<div class="bottom">
				<h4 class="h4"><?php the_field('block6_text2', $villas_postID); ?></h4>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="relax-unwind-2__body">
				<div class="relax-unwind-2__text">
					<h3 class="h3"><?php the_field('block7_title', $villas_postID); ?></h3>
					<div class="desc"><?php the_field('block7_text1', $villas_postID); ?></div>
					
					<?php $btn = get_field('block7_btn', $villas_postID); ?>
					<a href="<?php echo $btn["btn_link"]; ?>" class="btn-2">
						<?php echo $btn["btn_text"]; ?>
					</a>

					<div class="desc2"><?php the_field('block7_text2', $villas_postID); ?></div>
					<div class="subtitle"><?php the_field('block7_text3', $villas_postID); ?></div>
				...
				<div class="relax-unwind-2__img" style="">
					<img src="<?php echo wp_get_attachment_image_url(get_field('block7_image', $villas_postID), 'full'); ?>" class="img1">
	...
	<section class="find-place color" data-color="#F3FAFC">
		<div class="container">
			<h3 class="h3"><?php the_field('block8_title', $villas_postID); ?></h3>
	...
	<section class="what-we-love">
		<div class="container">
			<h3 class="h3"><?php the_field('block9_title', $villas_postID); ?></h3>
			
			<?php if(have_rows('block8_items', $villas_postID)) : ?>
				<div class="what-we-love__items">
					<?php while(have_rows('block8_items', $villas_postID)) : the_row(); ?>
